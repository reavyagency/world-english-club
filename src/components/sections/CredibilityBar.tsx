 ...
 *
 * Os números usam o mesmo degradê de marca da headline (`text-gradient-brand`),
 * aplicado no contêiner: `background-clip: text` recorta o degradê no texto dos
 * descendentes, então o `StatCounter` herda o efeito sem precisar saber dele.
 *
